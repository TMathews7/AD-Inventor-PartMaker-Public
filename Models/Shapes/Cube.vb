...
Namespace CubeDrawing
    Public Class Cube
        Public Sub DrawCube(width As Double, height As Double, depth As Double)
            Try
                ...
                Dim fileName As String = $"C:\Users\subto\Documents\InventorAuto\Parts\Shapes\Cube\Cube W{width / 2.54}_H{height / 2.54}_D{depth / 2.54}.ipt"
